...
FIREBASE_PRIVATE_KEY=BASE64_ENCODED_PRIVATE_KEY_PEM
...
- For Coolify, the least fragile `FIREBASE_PRIVATE_KEY` format is base64. Encode only the service account `private_key` value, not the full JSON file.
